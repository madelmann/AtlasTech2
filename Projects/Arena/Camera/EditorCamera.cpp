...
void EditorCamera::rotateX(float speed)
{
	// Always rotate the camera around the x-axis
	RotateView(speed * PI / 180.f, 1.f, 0.f, 0.f);

	convertViewToRotation();
}

void EditorCamera::rotateY(float speed)
{
	// Always rotate the camera around the y-axis
	RotateView(speed * PI / 180.f, 0.f, 1.f, 0.f);

	convertViewToRotation();
}

void EditorCamera::rotateZ(float speed)
{
	// Always rotate the camera around the y-axis
	RotateView(speed * PI / 180.f, 0.f, 0.f, 1.f);
